        ...
        <Row className="row-container">
              ...
              <Row>
                ...
                <Col span={11}>
                  <Input.Group>
                    ...
                    <Select defaultValue="Flightpark" style={{ width: "100%" }}>
                      <Option disabled value="Flightpark">
                      Flightpark
                      </Option>
          ...
          <Col span={6}>
            ...
            <Card title="Payment Details" style={{ width: "100%" }}>
              <p>
                <b>Per Ticket Cost: </b>Price. {this.props.fare}
              </p>
              <p>
                <b>Total Cost: </b>Price. {this.props.fare}
              </p>
            </Card>
          </Col>
          <Col span={4}></Col>
