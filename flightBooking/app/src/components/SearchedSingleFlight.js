...
const SearchedSingleFlight = ({ flight }) => {
    ...
    <Card>
      <Card.Content>
        <View>
          ...
          <Paragraph>{flight.price}</Paragraph>
          <View style={styles.rowFlex}>
            <View style={{ flex: 1 }}>
              <Text>{flight.seats} seats</Text>
            </View>
            <View style={{ flex: 3 }}>
              <Text>Time: {flight.time}</Text>
            </View>
          </View>
        </View>
      </Card.Content>
...
export default SearchedSingleFlight;
