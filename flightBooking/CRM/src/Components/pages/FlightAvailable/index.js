...
class FlightAvailable extends Component {
  ...
  fetchAvailableFlightes = async () => {
    const flightes = await getAvailableFlightesOfOwner().catch(err => {
  ...
  render() {
    return (
      <Layout title="My Flightes > Available flightes">
        <div className="d-flex" id="wrapper">
          <div id="page-content-wrapper">
            <div className="container-fluid">
              ...
              <h1 className="mt-2 text-primary">My Available flightes</h1>
