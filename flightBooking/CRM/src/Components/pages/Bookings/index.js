  ...
  fetchBookings = async () => {
    ...
    if (resp && resp.status === 200) {
      ...
      resp.data.map(booking => {
        ...
        booking.journeyDate = moment(booking.flight.journeyDate).format(
          "MMMM Do, YYYY"
        );
        booking.sn = counter;
        counter++;
        ...
        booking.flightNumber = booking.flight.flightNumber;
        booking.departure_time = booking.flight.departure_time;
        booking.image = booking.flight.image;
        booking.flightName = booking.flight.name;
        return booking;
      });
