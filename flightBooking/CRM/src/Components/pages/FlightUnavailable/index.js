...
class FlightUnavailable extends Component {
  ...
  fetchUnavailableFlightes = async () => {
    const flightes = await getUnavailableFlightesOfOwner().catch(err => {
  ...
  render() {
    return (
      <Layout title="My Flightes > Unavailable flightes">
        <div className="d-flex" id="wrapper">
          <div id="page-content-wrapper">
            <div className="container-fluid">
              ...
              <h1 className="mt-2 text-primary">My Unavailable Flightes</h1>
