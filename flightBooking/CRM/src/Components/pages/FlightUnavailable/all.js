...
import { removeFlight, getAllUnavailableFlightes } from "../../../Utils/Requests/Flight";
...
class FlightUnavailable extends Component {
  constructor(props) {
    super(props);
  ...
  fetchUnavailableFlightes = async () => {
    const flightes = await getAllUnavailableFlightes().catch(err => {
  ...
  render() {
    return (
      <Layout title="All Flightes > Unavailable flightes">
        <div className="d-flex" id="wrapper">
          <div id="page-content-wrapper">
            <div className="container-fluid">
              ...
              <h1 className="mt-2 text-primary">All Unavailable Flightes</h1>
...
export default memo(FlightUnavailable);
