...
export default class FormPrimaryDetails extends Component {
  continue = e => {
    ...
    if (
      ...
      !this.props.values.flightNumber
    ) {
      return Swal.fire({
        type: "error",
  ...
  render() {
    ...
    return (
      <Layout title="Add new flight (Primary details)">
        ...
        <div className="form-group">
          ...
          <input
            ...
            className="form-control"
            required
            placeholder="Enter the fare of flight"
        ...
        <div className="form-group">
          ...
          <input
            type="number"
            className="form-control"
            placeholder="Enter toal seats in the flight"
